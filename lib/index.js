...
class Packet {
	...
	static fromBuffer(buffer, offset = 0) {
		...
		switch (service) {
			...
			// Tunnel request
			case TunnelRequest.Service:
				return TunnelRequest.fromBuffer(buffer, 6);

			// Tunnel response
			case TunnelResponse.Service:
				return TunnelResponse.fromBuffer(buffer, 6);
